...
TICK_HZ 50 · GRID 6×18 · NUM_TILES 12 · PADDLE_W 2 (3 = casual mode) · PADDLE_GRACE 0.35 · DETENTS_PER_CELL 2.0 · KNOB_SIGN {+1,−1} · BALL_SPEED_START 7.0 · SPEEDUP_PER_HIT 1.07 · BALL_SPEED_MAX 22 · ENGLISH_GAIN 0.85 · VY_MIN 0.55 · SERVE_U {0.35,0.70} · WIN_SCORE 3 · READY_HOLD_MS 500 · COUNTDOWN_MS 1500 (3 ticks à 500) · POINT_FLASH_MS 1200 · WIN_CELEBRATION_MS 3000 · IDLE_TO_ATTRACT_MS 30000 · STALE_HOLD_RESET_MS 1000 · palette above · RING_BRIGHT 40/20/60-120 · WALL_BRIGHTNESS 40 (≤51) · TILE_MAP col0 rot180 / col1 rot0 · HEARTBEAT_REPAINT_S 2 · flags: NET_DOTS on · WALL_BLIP on · RALLY_PULSE off · ATTRACT_CHIRP off · SPEED_TINT_BALL off · CALIBRATION_MODE off.
